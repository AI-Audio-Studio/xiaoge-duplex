...
> 本目录汇总"小歌服务器多用户并发改造"的**全部**设计/评审/摸底文档。
> **⚠️ 接手工程师先读 [HANDOFF.md](HANDOFF.md)**(交接入口:现状 + 路线图 + 铁律),再回本页看文档地图。
> 截至 2026-07-09:编码主体已合入 main、已在阿里云部署跑起来、机上门过;余 PR-E 使能代码 + 上线五门
> (**当前状态以 HANDOFF.md 为准**,本页 §3 为早期快照)。

## 1. 文件清单（8 个，全部在本目录）

| 文件 | 角色 | 是什么 | 状态 |
| --- | --- | --- | --- |
| [HANDOFF.md](HANDOFF.md) | **研发交接(先读)** | 接手工程师入口:一分钟全局、读文档顺序、代码地图、已完成 vs 待办、铁律与流程、部署实况、路线图、开放决策、避坑 | **现行**(2026-07-09) |
