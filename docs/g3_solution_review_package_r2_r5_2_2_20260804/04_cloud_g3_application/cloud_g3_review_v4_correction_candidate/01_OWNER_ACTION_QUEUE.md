...
| 9 | 四方 owner | 当前测试阶段 G3 candidate 签收 | `证据/签收/OWNER_WEB_ONLY_G3_CANDIDATE_SIGNOFF_20260811.md` | PASS（测试阶段 G3 candidate），最终 SIGNOFF 仍依赖 REP-01 |

第 1、2 项已由 owner 回执关闭；第 3 项已由 Release owner 回执关闭源码可追溯边界。
第 4 项 `REP-01 clean checkout` 仍为最终 SIGNOFF 的未关闭项；第 5-9 项按当前测试阶段 G3 candidate 范围成立。
