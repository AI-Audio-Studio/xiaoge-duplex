...
class _ParticipantAudioOutput(io.AudioOutput):
    ...
    def clear_buffer(self) -> None:
        ...
        if not self._pushed_duration:
            return
        logger.debug(
            "audio playback buffer cleared",
            extra={
                "event": "playback_buffer_cleared",
                "source": "room_io._ParticipantAudioOutput.clear_buffer",
                "pushed_duration": round(self._pushed_duration, 3),
            },
        )
    ...
    async def _wait_for_playout(self) -> None:
        ...
        logger.debug(
            ...
            extra={
                ...
                "source": "room_io._ParticipantAudioOutput._wait_for_playout",
                "playback_position": round(pushed_duration, 3),
